    ...
    render() {
        return (
            <div className="container">
                <h1 style={{marginTop: '20px', textAlign: 'center'}}> Privacy Policy </h1>

                <hr />

                <div style={this.contentStyle}>
                    <p>Effective date: July 18, 2019</p>
                    <p>APU Confession Page (us, we or our) operates the https://www.apuconfessionpage.site website (the Service).</p>
                    <p>This page informs you of our policies regarding the collection, use, and disclosure of personal data when you use our Service and the choices you have associated with that data.</p>
                    <p>We use your data to make Facebook Post with page. By using the Service, you agree to the collection and use of information in accordance with this policy. Unless otherwise defined in this Privacy Policy, terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, accessible from https://www.apuconfessionpage.site/auth/admin/login</p>
                </div>
                ...
                <div style={this.contentStyle}>
                    <p>
                        ...
                        This Usage Data may include information such as your computer Internet Protocol address (e.g. IP address), browser type, browser version,
                ...
                <p>APU Confession Page uses the collected data for various purposes:</p>
                <ul>
                ...
                <div style={this.contentStyle}>
                    ...
                    <p>APU Confession Page will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information.</p>
                ...
                <div style={this.contentStyle}>
                    <p>APU Confession Page may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
                    <ul>
                        <li>To comply with a legal obligation</li>
                        <li>To protect and defend the rights or property of APU Confession Page</li>
                ...
                <hr />
                <div style={this.contentStyle}>
                    <p>We may employ third party companies and individuals to facilitate our Service (Service Provider),
